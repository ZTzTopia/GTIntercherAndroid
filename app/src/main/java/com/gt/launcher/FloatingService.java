...
public class FloatingService extends Service {
    ...
    public void onCreate() {
        ...
        imageView.setOnClickListener(v -> {
            if (mFloatingWidget.getVisibility() == View.VISIBLE) {
                ...
                updateWindowManagerParams(true);
                mFloatingWidget.setVisibility(View.GONE);
                ...
                updateWindowManagerParams(false);
    ...
    private void updateWindowManagerParams(boolean isHideMode) {
        ...
        // updateViewLayout caused the title bar disappear.
